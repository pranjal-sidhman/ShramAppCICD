...
class AppliedJobListFragment : Fragment() {
    lateinit var recyclerView: RecyclerView
    private lateinit var nodataImageView: ImageView
    private lateinit var jobAdapter: AppliedJobListAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getAppliedList(requireContext()!!.userid)


    }

    private fun getAppliedList(userid: String) {
        try {
            if (requireContext().isOnline) {
                viewModel.applyJobListResult.observe(requireActivity()) { response ->
                    ...
                    when (response) {
                        is BaseResponse.Success -> {
                            ...
                            if (response.data?.data.isNullOrEmpty()) {
                                ...
                                jobAdapter = AppliedJobListAdapter(
                                    requireContext(),
                                    jobList
                ...
                viewModel.getApplyJobList(requireContext().userid!!)
            ...
            Log.e("Job applied fragment", "Error occurred: ${e.localizedMessage}")
